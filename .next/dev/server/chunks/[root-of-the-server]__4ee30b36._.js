...
"[project]/app/api/pick-lists/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const pickLists = db.prepare(`
      SELECT * FROM pick_lists ORDER BY created_at DESC
    `).all();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(pickLists);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4ee30b36._.js.map